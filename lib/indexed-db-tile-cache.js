...
var IndexedDbTileCache = /** @class */ (function (_super) {
    ...
    IndexedDbTileCache.prototype.getTileEntry = function (tileCoordinates, downloadIfUnavaiable) {
        ...
        return new Promise(function (resolve, reject) {
            dbRequest.addEventListener("success", function (dbEvent) {
                var database = dbEvent.target.result;
                var tx = database.transaction([_this.options.objectStoreName]).objectStore(_this.options.objectStoreName).get(_this.createInternalTileUrl(tileCoordinates));
    ...
    IndexedDbTileCache.prototype.getTileAsDataUrl = function (tileCoordinates) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        blobAsDataUrl = function (blob, contentType) {
                            return new Promise(function (resolve, reject) {
                    ...
                    case 1:
                        tileEntry = _a.sent();
                        return [2 /*return*/, blobAsDataUrl(tileEntry.data, tileEntry.contentType).then(function (dataUrl) { return Promise.resolve(dataUrl); })];
                }
            });
        });
    };
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            dbRequest.addEventListener("success", function (dbEvent) {
                                var database = dbEvent.target.result;
                                var tx = database.transaction([_this.options.objectStoreName], "readwrite").objectStore(_this.options.objectStoreName).put(tileCacheEntry);
    ...
    IndexedDbTileCache.prototype.purgeStore = function () {
        ...
        return new Promise(function (resolve, reject) {
            dbRequest.addEventListener("success", function (dbEvent) {
                var database = dbEvent.target.result;
                var tx = database.transaction([_this.options.objectStoreName], "readwrite").objectStore(_this.options.objectStoreName).clear();
